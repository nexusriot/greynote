    ...
    const template = [
        {
            ...
            submenu: [
                ...
                { label: "Import notes…", click: () => send("command", "import") },
                { label: "Insert image…", click: () => send("command", "insert-image") },
                { type: "separator" },
                { role: "quit" },
            ],
        },
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: "Shared link", accelerator: "CmdOrCtrl+7", click: () => send("command", "view-shared") },
                { label: "Sessions", accelerator: "CmdOrCtrl+8", click: () => send("command", "view-sessions") },
                { label: "Users", accelerator: "CmdOrCtrl+9", click: () => send("command", "view-users") },
                { type: "separator" },
